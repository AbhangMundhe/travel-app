    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12">
          <h1 className="display-4 font-weight-bold text-uppercase text-center">Contact us</h1>
        </div>
      </div>
      <div className="row mt-5 mb-5">
        ...
        <div className="col-md-3 align-items-center">
          <i className="fa fa-map-marker fa-3x text-success mb-2" aria-hidden="true"></i>
          <h3>Location</h3>
          <p>Lonavala, Maharashtra.</p>
          <i className="fa fa-phone fa-3x text-success mt-4" aria-hidden="true"></i>
          <h3>Phone</h3>
          <p>+91-9587979697</p>
          <i className="fa fa-envelope fa-3x text-dark mt-4" aria-hidden="true"></i>
          <h3>Email</h3>
          <p>info@gmail.com</p>
        </div>
      </div>
      ...
      <div className="Contactus" style={{ backgroundColor: 'transparent' }}>
        ...
        <div className="row">
          <div className="col-md-6 mt-4">
            <input name="tbname" type="text" id="tbname" className="form-control my-2" placeholder="Name" />
          </div>
          <div className="col-md-6 mt-4">
            <input name="tbSubject" type="text" id="tbSubject" className="form-control my-2" placeholder="Subject" />
          </div>
        </div>
        <div className="row">
        ...
        <div className="row">
          <div className="col-md-12">
            <textarea name="tbMessage" id="tbMessage" cols="30" rows="10" className="form-control my-2" placeholder="Message"></textarea>
          </div>
        </div>
        <div className="row">
          <div className="col-md-12">
